...
public class Cpu extends Player{
    ...
    // 1º paso: crear el conjunto global y asignarlo a todas las celdas sin abrir
    ...
    // 2º paso: eliminar el conjunto global en aquellas celdas contiguas a una numero completado
    ...
    // 3º paso: crear el grupo para cada numero no completado
 ...
 // 4º paso: comprobar si hay alguna 100% seguro
    ...
    // 5º paso: comprobar si algun grupo sobrepasa a otro
    ...
    // 6º paso: eliminar aquellas celdas que puedan provocar un hueco
    ...
    // 7º paso: seleccionar un solo conjunto para cada (celda, incompleta)
                    ...
                    if (!cells[itn.get()].opened && !cells[itn.get()].listSets.isEmpty()) {
                        ...
                        while (it.hasNext()) {
                            ...
                            if (cells[i].listSets.contains(temp) && temp != stay) {
                                ...
                                System.out.println("Uno igual del mismo tamaño");
                                }*/
                                it.remove();
    ...
    // 8º paso: crea el conjunto de candidatos   YA NO PETA
...
//                        System.out.println("CANDIDATO: " + i);
 ...
 // 8º paso: crea el conjunto de candidatos sin tener en cuenta los espacios
