...
public class GameConfig implements Parcelable {
	...
	public int cpuLevel;
	//public ArrayList<ConfigPlayer> players;
	...
	public void writeToParcel(Parcel dest, int flags) {
		...
		/*for (int i = 0; i < players.size(); i++){
			dest.writeInt(players.get(i).playerID);
			dest.writeString(players.get(i).playerName);
			dest.writeInt(players.get(i).playerType);
		}*/
	}
	...
	private void readFromParcel(Parcel in) {
		...
		/*players = new ArrayList<ConfigPlayer> ();
		for (int i = 0; i < players.size(); i++){
			ConfigPlayer player = new ConfigPlayer();	
			player.playerID = in.readInt();
			player.playerName = in.readString();
			player.playerType = in.readInt();
			players.add(player);
		}*/
	}
    ...
    public void setDefaultOptions(){
		...
		//player1Type = PLAYER_IS_HUMAN;
		
		player2 = PLAYER_IS_CPU;
		player2Name = "Android";
		player2Level = DEFAULT_CPU_LEVEL;
		//player2Type = PLAYER_IS_CPU;
		...
		/*players = new ArrayList<ConfigPlayer> ();
		ConfigPlayer cplayer1 = new ConfigPlayer();
		cplayer1.playerID = 1;
		cplayer1.playerName = "Player_1";
		cplayer1.playerType = PLAYER_IS_HUMAN;

		ConfigPlayer cplayer2 = new ConfigPlayer();
		cplayer2.playerID = 2;
		cplayer2.playerName = "Cpu_1";
		cplayer2.playerType = PLAYER_IS_CPU;
